            ...
            {teamData.map((dev) => {
              return (
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-xl pb-8">
                    <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:text-left">
                      ...
                      <div className="flex flex-1 flex-col gap-1 sm:pt-4">
                        <h3 className="font-heading text-xl font-black text-white transition-colors group-hover:text-iwd-gold-300">
                          {dev.name}
                        </h3>
                        {dev.organization && (
                  ...
                  {dev.bio && (
                    <button
                      className="absolute -bottom-4 left-1/2 -translate-x-1/2 rounded-full border border-iwd-gold-400/30 bg-iwd-black-950 px-6 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-iwd-gold-400 shadow-[0_4px_20px_rgba(0,0,0,0.4)] transition-all duration-300 hover:scale-110 hover:border-iwd-gold-400 hover:bg-iwd-gold-400 hover:text-iwd-black-950 hover:shadow-iwd-gold-500/20 active:scale-95"
                      onClick={() =>
