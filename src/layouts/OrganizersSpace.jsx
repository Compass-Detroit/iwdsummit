      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-white/5 bg-white/[0.03] p-8 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-white/20 hover:bg-white/[0.07] hover:shadow-2xl hover:shadow-black/50">
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col gap-1">
            <h4 className="font-heading text-xl font-black tracking-tight text-white transition-colors group-hover:text-iwd-gold-300">
              {name}
            </h4>
            <span className="text-xs font-bold uppercase tracking-widest text-iwd-gold-400/60 transition-colors group-hover:text-iwd-gold-400">
          ...
          <div className="mt-2 flex translate-y-2 gap-3 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
            {linkedin && (
              <a
                ...
                className="rounded-lg bg-white/5 p-2 text-white/50 transition-all hover:bg-[#0077b5] hover:text-white"
              >
            ...
            {github && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-lg bg-white/5 p-2 text-white/50 transition-all hover:bg-[#333] hover:text-white"
              >
                <FaGithub className="size-4" />
              </a>
            )}
            {!linkedin && !github && (
              <div className="rounded-lg bg-white/5 p-2 text-[10px] font-bold uppercase italic tracking-widest text-white/20">
                Social Off
              </div>
            )}
          </div>
...
export default function OrganizersSpace() {
  ...
  return (
    <section
      id="organizers-space"
      className="relative overflow-hidden bg-iwd-black-900 py-32 sm:py-48"
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-32 flex flex-col items-center text-center">
          ...
          <p className="mt-8 max-w-2xl font-body text-lg font-light leading-relaxed text-white/40 sm:text-xl">
