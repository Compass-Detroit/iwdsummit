    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-6 sm:p-10">
        ...
        <div className="flex flex-col gap-2 border-l-2 border-iwd-gold-400/40 pl-6 transition-colors group-hover:border-iwd-gold-400">
          ...
          <span className="text-xs font-bold uppercase tracking-[0.3em] text-white/40 group-hover:text-iwd-gold-400/60">
            {title}
          </span>
        </div>
      </div>
...
export default function InspirationalMural() {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden bg-iwd-black-950 py-32 sm:py-48"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-24 flex flex-col items-center text-center">
          ...
          <p className="mt-10 max-w-3xl font-body text-xl font-light leading-relaxed text-white/60">
        ...
        {showAll && (
          <div className="mt-20 flex justify-center">
            <button
              ...
              className="group flex items-center gap-3 font-heading text-sm font-black uppercase tracking-widest text-white/30 transition-colors hover:text-white"
            >
